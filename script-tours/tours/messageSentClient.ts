	...
	const stepsArray: ISteps[] = [
		{
			...
			description: "### This is the complete flowchart of how a message is sent. We will understand this in detail over the next two tours iterating through multiple steps\n\nClick [here](https://res.cloudinary.com/dty2rgx6f/image/upload/v1711399283/Codetours/Sending%20Message/Sending_Message_qjxrl1.png) to open this is browser.\n\n![](https://res.cloudinary.com/dty2rgx6f/image/upload/v1711399283/Codetours/Sending%20Message/Sending_Message_qjxrl1.png)"
		},
		{
